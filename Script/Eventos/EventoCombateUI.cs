...
public class EventoCombateUI : MonoBehaviour
{
    ...
    void FecharCombate(bool sucesso)
    {
        ...
        else
        {
             ...
             if(eventoUI) eventoUI.FinalizarCicloDoEvento(sucesso);
        }
    }
    ...
    void AtualizarBarras(float vidaHeroi, float armaduraHeroi, float maxHeroi, 
                         float vidaMonstro, float armaduraMonstro, float maxMonstro)
    {
        if (barraVidaHeroi) 
            barraVidaHeroi.SetValores(vidaHeroi + armaduraHeroi, maxHeroi + armaduraHeroi);
            
        if (barraVidaMonstro) 
            barraVidaMonstro.SetValores(vidaMonstro + armaduraMonstro, maxMonstro + armaduraMonstro);
    }
